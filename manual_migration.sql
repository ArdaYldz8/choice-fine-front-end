-- Manual migration to add image_url column and update bakery products
-- Run this directly in Supabase SQL editor

-- Add image_url column if it doesn't exist
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS image_url TEXT;

-- Update bakery products with specific image URLs
...
-- Check results
SELECT id, name, category, image_url FROM public.products WHERE category = 'BAKERY' AND image_url IS NOT NULL; 